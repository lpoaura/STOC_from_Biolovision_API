...
INSERT INTO pr_stoc.bib_code_points (id, type_code, principal, colonne, code, code_vn, libelle, libelle_vn)
VALUES (1, 'habitat', 'A', '0', 'A', 'A0_A', 'Forêt (arbres > 5m de hauteur)', 'Forêt (arbres > 5m de hauteur)'),
       ...
       (27, 'habitat', 'B', '0', 'B', 'B0_B', 'Buissons (ou jeune forêt < 5m de hauteur)',
       ...
       (183, 'nuage', NULL, NULL, '2', 'TWO_THIRD', '33-66 %', '33 – 66%'),
       (182, 'nuage', NULL, NULL, '1', 'ONE_THIRD', '0-33 %', '0 – 33%'),
       (184, 'nuage', NULL, NULL, '3', 'THREE_THIRD', '66-100 %', '66 – 100%'),
...
INSERT INTO pr_stoc.cor_euring_vn_taxref (code_euring, num_euring, taxref_cd_nom, vn_id_species)
VALUES ('OENOENLEU', 11462, 4068, 1453),
